...
- **Jobs.** Everyone draws one of eight (Architect builds 25% cheaper, Barrister pays 20% less rent,
  Conductor doubles station rent, Gambler doubles minigame winnings…). Each pays a bonus on every GO and
  **promotes** on the 3rd and 6th lap to ×1.5 then ×2.
